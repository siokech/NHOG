...
const timer1 = new CountdownTimer({
    selector: "#clock1",
    targetDate: new Date("February, 24 2025 8:00:00"),
});
...
const timer2 = new CountdownTimer({
    selector: "#clock2",
    targetDate: new Date("March, 11 2025 8:00:00"),
});
...
const timer3 = new CountdownTimer({
    selector: "#clock3",
    targetDate: new Date("April, 10 2025 9:30:00"),
});
...
const timer4 = new CountdownTimer({
    selector: "#clock4",
    targetDate: new Date("August, 11 2025 8:30:00"),
});
...
const timer5 = new CountdownTimer({
    selector: "#clock5",
    targetDate: new Date("February, 24 2025 16:30:00"),
});
